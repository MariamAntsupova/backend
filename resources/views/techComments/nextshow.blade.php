...
<section id="header_section_wrapper" class="header_section_wrapper">
    ...
    <div class="col-md-5" style="margin-left: 20%">
                <div class="feature_static_last_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="{{ asset ('/').$techPosts->image }}" alt="feature-top">
                    </div>
                        <!-- feature_article_img -->
                    ...
                    <div class="feature_article_inner">
                            ...
                            <div class="feature_article_title">
                                <h1><a target="_self">{{ $techPosts->title }}</a></h1>
                            </div>
    ...
    <div class="entity_comment_from">
        <form action="{{ route('adminstore')}}" method="POST">
            @csrf
            <input type="hidden" name="post_id" value="{{ $techPosts->id }}">
    ...
    <div class="container">
        @foreach ($techComments as $comment)
