@extends('layouts.app')
    ...
    <title>Update Profile - CYBER MEDIA • SECLAB</title>
        ...
        <div class="page-content">
                        <div class="col-xs-12 col-sm-6 col-md-4 center-box">
                            <div class="content page-contact page-login">
                                ...
                                <h1 class="page-title text-center">პროფილის განახლება</h1>

                                <form action='{{ route('homepage') }}' enctype="multipart/form-data" method="post" >
                                    @csrf
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="row">
                                                    {{-- <img src="{{ asset('images')."/".$image->image }}" alt="File doesn't exist" --}}
{{--                                                                                     <img src="./Update Profile - CYBER MEDIA • SECLAB_files/user.png" alt="avatar" class="thumbnail img-responsive img-update">
 --}}                                                                           </div> 
                                         <div class="row text-center btn-change-avatar">
                                            <a class="btn btn-secondary btn-sm position-relative">
                                                ავატარი                                        <input type="file" name="image" size="40" class="uploadFile" accept=".png, .jpg, .jpeg" onchange="$(&#39;#upload-file-info&#39;).html($(this).val());">
                                            </a>
                                        </div> 
                                ...
                                <div class="form-group has-feedback col-sm-12">
                                    <div class="row">
                                        <input type="text" name="name" class="form-control" placeholder="სახელი" value="{{ Auth::user()->name }}" style="width: 100%">
                                ...
                                <div class="form-group has-feedback col-sm-12">
                                    <div class="row">
                                        <input type="email" name="email" class="form-control" placeholder="ელ-ფოსტა" value="{{ Auth::user()->email }}" style="width: 100%">
